/**
 * C02.js build from https://github.com/thegreenwebfoundation/co2.js
 */
...
Falling back to global average grid intensity.`))),(t||t===0)&&(typeof t=="object"?(E.data[t.country?.toUpperCase()]||(console.warn(`"${t.country}" is not a valid country. Please use a valid 3 digit ISO 3166 country code. 
...
Falling back to default value.`))),(o?.firstVisitPercentage||o.firstVisitPercentage===0)&&(typeof o.firstVisitPercentage=="number"?o.firstVisitPercentage>=0&&o.firstVisitPercentage<=1?e.firstVisitPercentage=o.firstVisitPercentage:(e.firstVisitPercentage=g,console.warn(`The firstVisitPercentage option must be a number between 0 and 1. You passed in ${o.firstVisitPercentage}. 
Falling back to default value.`)):(e.firstVisitPercentage=g,console.warn(`The firstVisitPercentage option must be a number. You passed in a ${typeof o.firstVisitPercentage}. 
Falling back to default value.`))),(o?.returnVisitPercentage||o.returnVisitPercentage===0)&&(typeof o.returnVisitPercentage=="number"?o.returnVisitPercentage>=0&&o.returnVisitPercentage<=1?e.returnVisitPercentage=o.returnVisitPercentage:(e.returnVisitPercentage=y,console.warn(`The returnVisitPercentage option must be a number between 0 and 1. You passed in ${o.returnVisitPercentage}. 
Falling back to default value.`)):(e.returnVisitPercentage=y,console.warn(`The returnVisitPercentage option must be a number. You passed in a ${typeof o.returnVisitPercentage}. 
Falling back to default value.`))),e}var P=class{constructor(e){this.options=e}energyPerByteByComponent(e){let n=e/m.GIGABYTE*D;return{consumerDeviceEnergy:n*C,networkEnergy:n*O,productionEnergy:n*S,dataCenterEnergy:n*p}}co2byComponent(e,r=s,n={}){let t=s,a=s,i=s,d=s;if(n?.gridIntensity){let{device:c,network:u,dataCenter:L}=n.gridIntensity;c?.value&&(t=c.value),u?.value&&(a=u.value),L?.value&&(i=L.value)}r===!0&&(i=f);let l={};for(let[c,u]of Object.entries(e))c.startsWith("dataCenterEnergy")?l[c.replace("Energy","CO2")]=u*i:c.startsWith("consumerDeviceEnergy")?l[c.replace("Energy","CO2")]=u*t:c.startsWith("networkEnergy")?l[c.replace("Energy","CO2")]=u*a:l[c.replace("Energy","CO2")]=u*d;return l}perByte(e,r=!1,n=!1,t={}){e<1&&(e=0);let a=this.energyPerByteByComponent(e,t);if(typeof r!="boolean")throw new Error(`perByte expects a boolean for the carbon intensity value. Received: ${r}`);let i=this.co2byComponent(a,r,t),l=Object.values(i).reduce((c,u)=>c+u);return n?{...i,total:l}:l}perVisit(e,r=!1,n=!1,t={}){let a=this.energyPerVisitByComponent(e,t);if(typeof r!="boolean")throw new Error(`perVisit expects a boolean for the carbon intensity value. Received: ${r}`);let i=this.co2byComponent(a,r,t),l=Object.values(i).reduce((c,u)=>c+u);return n?{...i,total:l}:l}energyPerByte(e){let r=this.energyPerByteByComponent(e);return Object.values(r).reduce((t,a)=>t+a)}energyPerVisitByComponent(e,r={},n=g,t=y,a=N){r.dataReloadRatio&&(a=r.dataReloadRatio),r.firstVisitPercentage&&(n=r.firstVisitPercentage),r.returnVisitPercentage&&(t=r.returnVisitPercentage);let i=this.energyPerByteByComponent(e),d={},l=Object.values(i);for(let[c,u]of Object.entries(i))d[`${c} - first`]=u*n,d[`${c} - subsequent`]=u*t*a;return d}energyPerVisit(e){let r=0,n=0,t=Object.entries(this.energyPerVisitByComponent(e));for(let[a,i]of t)a.indexOf("first")>0&&(r+=i);for(let[a,i]of t)a.indexOf("subsequent")>0&&(n+=i);return r+n}emissionsPerVisitInGrams(e,r=s){return R(e*r)}annualEnergyInKwh(e,r=1e3){return e*r*12}annualEmissionsInGrams(e,r=1e3){return e*r*12}annualSegmentEnergy(e){return{consumerDeviceEnergy:R(e*C),networkEnergy:R(e*O),dataCenterEnergy:R(e*p),productionEnergy:R(e*S)}}};var _=P;var G=class{constructor(e){if(this.model=new _,e?.model==="1byte")this.model=new V;else if(e?.model==="swd")this.model=new _;else if(e?.model)throw new Error(`"${e.model}" is not a valid model. Please use "1byte" for the OneByte model, and "swd" for the Sustainable Web Design model.
